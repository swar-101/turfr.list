    ...
    return (
        ...
        >
            ...
            <h2 className="mt-2 ml-1 text-lg font-semibold text-zinc-300">
                { amount > 0 ? `Pay ₹{amount}` : "Wait for organizer to update the amount" }
            </h2>
            ...
            <div
                ...
                className="
                  ...
                  "
            >
                <span onClick={copyUpi} className="material-symbols-outlined text-zinc-400 cursor-pointer">
                    content_copy
                </span>
                <div>
                    <p className="text-xs text-zinc-500">UPI ID</p>
                    <p className="font-semibold text-zinc-200 tracking-wide">
                        {upiId || "UPI not set by the organizer yet"}
                    </p>
                    {copied && (
